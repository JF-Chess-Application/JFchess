...
ActiveRecord::Schema.define(version: 20180914023329) do
  ...
  create_table "captured_pieces", force: :cascade do |t|
    ...
    t.index ["game_id"], name: "index_captured_pieces_on_game_id", using: :btree
    t.index ["user_id"], name: "index_captured_pieces_on_user_id", using: :btree
  end
